...
module.exports = (robot) ->
 ...
 sarcasticResponses = [
  "#{lastFloor} floor, and don’t ask me again.", 
  "You should go eat on floor 666!", 
  "Do you really need to eat today?", 
  "Eating is for the weak!", "You must have the mental capacity of a goldfish. I already told you #{lastFloor} floor.", 
  "Eat on floor #{lastFloor} and 3/4.", 
  "You should eat at your desk alone because I don’t want to say it again http://s.quickmeme.com/img/11/11af033ca528b880096cd9ba73adb30ff4f27ec053473fc3f4c5cac981ee4c21.jpg"
]
